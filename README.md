...
- RankNet
  ...
  ```
  java -jar RankLib-2.8.jar -train MSLR-WEB10K/Fold1/train.txt -validate MSLR-WEB10K/Fold1/vali.txt -test MSLR-WEB10K/Fold1/test.txt -ranker 1  -epoch 50 -layer 2 -node 25 -lr 0.00005 -metric2t NDCG@10 -save IRDMCW/modelranknet19_trial14.txt
  ```
